/**
 * @name isClassroomSchemaValidated.js
 * @author The World Wolf 95
 * @description
 *      This policy permits to verify if a classroom body which sended is correct. 
 */
